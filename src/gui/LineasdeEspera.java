...
public class LineasdeEspera extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        lblFoot4 = new javax.swing.JLabel();
        ...
        lblHOME.setBackground(new java.awt.Color(102, 102, 102));
        ...
        lblComplexNumbers.setForeground(new java.awt.Color(102, 102, 102));
        lblComplexNumbers.setText("LINEAS DE ESPERA");
        pnlComplexNumbers.add(lblComplexNumbers, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 30, 500, 50));

        SeriesFourier.setBackground(new java.awt.Color(255, 255, 255));
        SeriesFourier.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/lineadeespera.png"))); // NOI18N
        ...
        pnlComplexNumbers.add(SeriesFourier, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 10, -1, 90));

        lblIndicacion1.setFont(new java.awt.Font("Segoe UI", 2, 14)); // NOI18N
        lblIndicacion1.setForeground(new java.awt.Color(255, 255, 255));
        lblIndicacion1.setText("Optimiza la operacion de los servicios aplicando la teoria de lineas de espera.");
        pnlComplexNumbers.add(lblIndicacion1, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 80, 580, 20));

        lblFoot4.setForeground(new java.awt.Color(255, 51, 0));
        lblFoot4.setText("ITESS-TICS-2023 AGO-DIC");
        pnlComplexNumbers.add(lblFoot4, new org.netbeans.lib.awtextra.AbsoluteConstraints(640, 440, -1, -1));

        lblFoot2.setForeground(new java.awt.Color(255, 51, 0));
        lblFoot2.setText("Proyecto: JMB");
        pnlComplexNumbers.add(lblFoot2, new org.netbeans.lib.awtextra.AbsoluteConstraints(640, 460, -1, -1));

        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/unidad5.PNG"))); // NOI18N
        jLabel2.setText("jLabel2");
        pnlComplexNumbers.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 130, 520, 290));
    ...
    private javax.swing.JLabel lblFoot4;
