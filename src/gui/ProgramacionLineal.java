...
public class ProgramacionLineal extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        lblHOME.setBackground(new java.awt.Color(255, 0, 0));
        ...
        lblComplexNumbers.setForeground(new java.awt.Color(255, 0, 0));
        ...
        lblLogoComplexNumbers.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/progralineal.jpg"))); // NOI18N
        lblLogoComplexNumbers.setText("jLabel1");
        pnlComplexNumbers.add(lblLogoComplexNumbers, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 20, 150, 90));

        lblIndicacion.setFont(new java.awt.Font("Segoe UI", 2, 14)); // NOI18N
        lblIndicacion.setForeground(new java.awt.Color(255, 255, 255));
        lblIndicacion.setText("optimizacion de de recursos en problemas que involucran mezclas de recursos o prductos.");
        pnlComplexNumbers.add(lblIndicacion, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 90, 570, 20));

        lblIndicacion1.setFont(new java.awt.Font("Segoe UI", 2, 14)); // NOI18N
        lblIndicacion1.setForeground(new java.awt.Color(255, 255, 255));
        lblIndicacion1.setText("Aplica los metodos graficos, simplex, de la M, y de las dos fases para la");
        pnlComplexNumbers.add(lblIndicacion1, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 70, 470, 20));
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/unidad1.PNG"))); // NOI18N
        jLabel1.setText("jLabel1");
        pnlComplexNumbers.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 140, 500, 340));
