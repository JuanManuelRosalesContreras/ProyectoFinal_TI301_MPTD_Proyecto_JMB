...
public class Teoriadeinventarios extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        lblHOME.setBackground(new java.awt.Color(51, 255, 0));
        ...
        lblComplexNumbers.setForeground(new java.awt.Color(102, 255, 0));
        lblComplexNumbers.setText("TEORIA DE INVENTARIOS");
        pnlComplexNumbers.add(lblComplexNumbers, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 20, 430, 50));
        ...
        lblLogoComplexNumbers.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/inventarios.png"))); // NOI18N
        lblLogoComplexNumbers.setText("jLabel1");
        pnlComplexNumbers.add(lblLogoComplexNumbers, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 20, 150, 90));

        lblIndicacion1.setFont(new java.awt.Font("Segoe UI", 2, 14)); // NOI18N
        lblIndicacion1.setForeground(new java.awt.Color(255, 255, 255));
        lblIndicacion1.setText("operativa de una organizacion.");
        pnlComplexNumbers.add(lblIndicacion1, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 90, 410, 20));

        lblFoot1.setForeground(new java.awt.Color(255, 51, 0));
        lblFoot1.setText("Proyecto: JMB");
        pnlComplexNumbers.add(lblFoot1, new org.netbeans.lib.awtextra.AbsoluteConstraints(650, 480, -1, -1));

        lblFoot3.setForeground(new java.awt.Color(255, 51, 0));
        lblFoot3.setText("ITESS-TICS-2023 AGO-DIC");
        pnlComplexNumbers.add(lblFoot3, new org.netbeans.lib.awtextra.AbsoluteConstraints(650, 460, -1, -1));

        lblIndicacion2.setFont(new java.awt.Font("Segoe UI", 2, 14)); // NOI18N
        lblIndicacion2.setForeground(new java.awt.Color(255, 255, 255));
        lblIndicacion2.setText("Utiliza la teoria de inventarios como una herramienta para la mejora");
        pnlComplexNumbers.add(lblIndicacion2, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 70, 440, 20));

        jLabel1.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/unidad4.PNG"))); // NOI18N
        jLabel1.setText("jLabel1");
        pnlComplexNumbers.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 120, 530, 390));
        ...
        layout.setVerticalGroup(
            layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(pnlComplexNumbers, javax.swing.GroupLayout.DEFAULT_SIZE, 520, Short.MAX_VALUE)
        );
    ...
    private void lblHOMEMouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblHOMEMouseExited
        ...
        lblHOME.setBackground(Color.green);
